            ...
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="dz-bnr-inr-entry">
                        ...
                        <div class="dz-player style-2 m-b30" data-src="assets/song/song3.mp3">
                            <h5 class="title">Afrobeat DonMix</h5>
                            ...
                            <div class="dz-player-range">
                                ...
                                <input class="dzPlayRange w-100" type="range" min="0" value="0" step="1" max="251"><span class="change-dz-player-range"></span>
                            </div>
                            <div class="dzPlayNum">
                                <span class="dzPlayDuration">4:11</span>
                            </div>
        ...
        <div class="container">
            <form class="header-item-search">
                <div class="input-group search-input">
                    ...
                    <input type="text" class="form-control" aria-label="Text input with dropdown button" placeholder="Search Beat">
